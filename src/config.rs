...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
		        ...
		        map.insert("password".into(), "1qazXSW@".into());
		        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.itenx.net"];
pub const RS_PUB_KEY: &str = "Kw18ZwofyvY+MAwMBR4eWzdAPQJRslMJQaqYGFjV3DA=";
